...
function Home() {
    ...
    return (
        <div className='home'>
            ...
            <p>The purpose of this game is to know how conversant are you to 
        ...
        <p>There are 10 questions all together. You can only click on next 
            button to move to the next questio but you can not access the previous again.
            </p>
        
            <p>At the end of the question, you will ahve access to your score</p>
            <br />
